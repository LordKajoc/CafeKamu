...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigation.add(new MeowBottomNavigation.Model(3, R.drawable.ic_baseline_menu_book_24));
        bottomNavigation.add(new MeowBottomNavigation.Model(4, R.drawable.ic_baseline_smoking_rooms_24));
